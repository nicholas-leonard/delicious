SELECT 	a.config_id, a.description, b.epoch_count AS epoch, hps3.get_end(a.config_id) AS eend, (a.end_time IS NOT NULL) AS done,
	n.w_lr_scale, v.W_lr_scale, v.dim, v.max_col_norm, a.layer_array, a.ext_array, 
...
FROM 	hps3.config_mlp_sgd AS a, (	
	...
	) AS b, hps3.dataset AS p, hps3.layer_tanh AS v, hps3.layer_softmax AS n
WHERE  a.config_id = b.config_id AND b.rank = 1 AND a.task_id = 19 AND a.dataset_id = p.dataset_id 
...
WHERE a.config_id = 7594 AND (b.config_id, b.epoch_count) = (a.config_id, a.epoch_count)
