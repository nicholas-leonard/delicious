SELECT 	a.config_id, a.dataset_id, task_id, a.description, b.epoch_count AS epoch, hps3.get_end(a.config_id) AS eend, (a.end_time IS NOT NULL) AS done,
	a.learning_rate, a.init_momentum, v.dim, v.hidden_dim, v.stochastic_ratio, v.sparsity_target, v.noise_beta, v.noise_stdev, v.noise_normality, v.weight_decay_coeff, a.layer_array, a.ext_array, 
...
FROM 	hps3.config_mlp_sgd AS a, (	
		...
		WHERE channel_name = 'test_hps_cost'
	) AS b, hps3.dataset AS p, stochastic.layer_conditional3 AS v, hps3.layer_softmax AS n
WHERE  a.config_id = b.config_id AND b.rank = 1 AND (task_id = 35) AND a.dataset_id = p.dataset_id 
