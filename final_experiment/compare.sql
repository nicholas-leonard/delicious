SELECT 	a.config_id, a.dataset_id, task_id, a.description, b.epoch_count AS epoch, hps3.get_end(a.config_id) AS eend, (a.end_time IS NOT NULL) AS done,
	a.learning_rate AS lrate, a.init_momentum AS mt, b.channel_value AS optimum_valid_mca, 
...
FROM 	hps3.config_mlp_sgd AS a, (	
	...
	) AS b, hps3.dataset AS p
WHERE  a.config_id = b.config_id AND b.rank = 1 AND (task_id BETWEEN 56 AND 60) AND a.dataset_id = p.dataset_id 
