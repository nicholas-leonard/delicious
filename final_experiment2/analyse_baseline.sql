SELECT 	a.config_id, a.dataset_id, task_id, a.description, b.epoch_count AS epoch, hps3.get_end(a.config_id) AS eend, (a.end_time IS NOT NULL) AS done,
	a.learning_rate, a.init_momentum, v.dim, v.hidden_dim, v.sparsity_target, v.noise_beta, v.noise_stdev, v.noise_normality, v.max_col_norm, a.layer_array, a.ext_array, 
	hps3.get_channel(a.config_id, 'train_conditional50_mean_output_sparsity', b.epoch_count) AS mean_sparsity, 
	hps3.get_channel(a.config_id, 'train_conditional50_max_unit_sparsity_prop', b.epoch_count) AS maxusp,
	hps3.get_channel(a.config_id, 'train_conditional50_min_unit_sparsity_prop', b.epoch_count) AS minusp,
	hps3.get_channel(a.config_id, 'train_conditional50_mean_sparsity_prop0.2', b.epoch_count) AS msp2,
	hps3.get_channel(a.config_id, 'train_conditional50_mean_sparsity_prop0.3', b.epoch_count) AS msp3,
	hps3.get_channel(a.config_id, 'train_conditional50_mean_sparsity_prop0.4', b.epoch_count) AS msp4,
	hps3.get_channel(a.config_id, 'train_conditional50_mean_sparsity_prop', b.epoch_count) AS msp5,
	hps3.get_channel(a.config_id, 'train_conditional50_mean_unit_sparsity_meta_prop', b.epoch_count) AS musmp,
	hps3.get_channel(a.config_id, 'train_conditional50_mean_unit_sparsity_meta_prop2', b.epoch_count) AS musmp2,
	hps3.get_channel(a.config_id, 'train_conditional50_output_stdev', b.epoch_count) AS stdev,
	hps3.get_channel(a.config_id, 'train_conditional50_output_meta_stdev', b.epoch_count) AS mstdev,
...
FROM 	hps3.config_mlp_sgd AS a, (	
	...
	) AS b, hps3.dataset AS p, stochastic.layer_conditional5 AS v, hps3.layer_softmax AS n
WHERE  a.config_id = b.config_id AND b.rank = 1 AND (task_id < 70) AND a.dataset_id = p.dataset_id 
	AND a.layer_array[1] = v.layer_id AND a.layer_array[2] = n.layer_id AND (v.dim = 2000 OR v.dim = 200)
...
WHERE a.config_id = 8779 AND (b.config_id, b.epoch_count) = (a.config_id, a.epoch_count)
	AND (c.config_id, c.epoch_count) = (a.config_id, a.epoch_count) AND (d.config_id, d.epoch_count) = (a.config_id, a.epoch_count) 
	AND a.channel_name = 'train_objective' AND b.channel_name = 'valid_hps_cost' AND c.channel_name = 'test_hps_cost' AND d.channel_name = 'train_conditional50_mean_sparsity_prop0.2'
