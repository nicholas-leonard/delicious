SELECT 	a.config_id, a.dataset_id, a.description, b.epoch_count AS epoch, hps3.get_end(a.config_id) AS eend, (a.end_time IS NOT NULL) AS done,
	n.w_lr_scale, v.W_lr_scale, v.dim, v.hidden_dim, v.mean_loss_coeff, v.sparsity_target, v.sparsity_cost_coeff, 
...
WHERE  a.config_id = b.config_id AND b.rank = 1 AND a.task_id = 25 AND a.dataset_id = p.dataset_id 
...
ORDER BY (b.channel_value/((hps3.get_channel(a.config_id, 'train_stochastic20_mean_output_sparsity', b.epoch_count) ^2)
	*(1+COALESCE(hps3.get_channel(a.config_id, 'train_stochastic20_max_unit_sparsity_prop', b.epoch_count),0))
	*(1+COALESCE(hps3.get_channel(a.config_id, 'train_stochastic20_mean_unit_sparsity_meta_prop2', b.epoch_count),0))
	)) DESC
...
WHERE a.config_id = 7758 AND (b.config_id, b.epoch_count) = (a.config_id, a.epoch_count)
