SELECT 	a.config_id, a.dataset_id, a.description, b.epoch_count AS epoch, hps3.get_end(a.config_id) AS eend, (a.end_time IS NOT NULL) AS done,
	n.w_lr_scale, v.W_lr_scale, v.max_col_norm, v.dim, v.hidden_dim, v.mean_loss_coeff, v.sparsity_target, v.sparsity_cost_coeff, 
	w.W_lr_scale, w.max_col_norm, w.dim, w.hidden_dim, w.mean_loss_coeff, w.sparsity_target, w.sparsity_cost_coeff, 
	a.layer_array, a.ext_array, 
	hps3.get_channel(a.config_id, 'train_stochastic20_mean_output_sparsity', b.epoch_count) AS mean_sparsity, 
	hps3.get_channel(a.config_id, 'train_stochastic20_max_unit_sparsity_prop', b.epoch_count) AS maxusp,
	hps3.get_channel(a.config_id, 'train_stochastic20_min_unit_sparsity_prop', b.epoch_count) AS minusp,
	hps3.get_channel(a.config_id, 'train_stochastic20_mean_sparsity_prop', b.epoch_count) AS msp,
	hps3.get_channel(a.config_id, 'train_stochastic20_mean_unit_sparsity_meta_prop', b.epoch_count) AS musmp,
	hps3.get_channel(a.config_id, 'train_stochastic20_mean_unit_sparsity_meta_prop2', b.epoch_count) AS musmp2,
	hps3.get_channel(a.config_id, 'train_stochastic21_mean_output_sparsity', b.epoch_count) AS mean_sparsityb, 
	hps3.get_channel(a.config_id, 'train_stochastic21_max_unit_sparsity_prop', b.epoch_count) AS maxuspb,
	hps3.get_channel(a.config_id, 'train_stochastic21_min_unit_sparsity_prop', b.epoch_count) AS minuspb,
	hps3.get_channel(a.config_id, 'train_stochastic21_mean_sparsity_prop', b.epoch_count) AS mspb,
	hps3.get_channel(a.config_id, 'train_stochastic21_mean_unit_sparsity_meta_prop', b.epoch_count) AS musmpb,
	hps3.get_channel(a.config_id, 'train_stochastic21_mean_unit_sparsity_meta_prop2', b.epoch_count) AS musmp2b,
...
FROM 	hps3.config_mlp_sgd AS a, (	
	...
	) AS b, hps3.dataset AS p, stochastic.layer_stochastic2 AS v, stochastic.layer_stochastic2 AS w,stochastic.layer_stochasticsoftmax AS n
WHERE  a.config_id = b.config_id AND b.rank = 1 AND (a.task_id = 43) AND a.dataset_id = p.dataset_id 
	AND a.layer_array[1] = v.layer_id AND a.layer_array[2] = w.layer_id AND a.layer_array[3] = n.layer_id 
	--AND hps3.get_channel(a.config_id, 'train_stochastic20_mean_sparsity_prop', b.epoch_count) IS NOT NULL
	--AND hps3.get_channel(a.config_id, 'train_stochastic20_mean_sparsity_prop', b.epoch_count) != 0
	--AND hps3.get_channel(a.config_id, 'train_stochastic20_max_unit_sparsity_prop', b.epoch_count) < 0.4
...
WHERE a.config_id = 8838 AND (b.config_id, b.epoch_count) = (a.config_id, a.epoch_count)
