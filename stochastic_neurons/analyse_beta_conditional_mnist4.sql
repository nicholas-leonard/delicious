...
WHERE  a.config_id = b.config_id AND b.rank = 1 AND (task_id = 33 or task_id = 34) AND a.dataset_id = p.dataset_id 
...
WHERE a.config_id = 8683 AND (b.config_id, b.epoch_count) = (a.config_id, a.epoch_count)
