...
WHERE  a.config_id = b.config_id AND b.rank = 1 AND a.task_id = 23 AND a.dataset_id = p.dataset_id 
...
WHERE a.config_id = 7611 AND (b.config_id, b.epoch_count) = (a.config_id, a.epoch_count)
