SELECT 	a.config_id, a.dataset_id, a.description, b.epoch_count AS epoch, hps3.get_end(a.config_id) AS eend, (a.end_time IS NOT NULL) AS done,
	...
	hps3.get_channel(a.config_id, 'train_stochastic30_mean_output_sparsity', b.epoch_count) AS mean_sparsity, 
	hps3.get_channel(a.config_id, 'train_stochastic30_max_unit_sparsity_prop', b.epoch_count) AS maxusp,
	hps3.get_channel(a.config_id, 'train_stochastic30_min_unit_sparsity_prop', b.epoch_count) AS minusp,
	hps3.get_channel(a.config_id, 'train_stochastic30_mean_sparsity_prop0.2', b.epoch_count) AS msp2,
	hps3.get_channel(a.config_id, 'train_stochastic30_mean_sparsity_prop0.3', b.epoch_count) AS msp3,
	hps3.get_channel(a.config_id, 'train_stochastic30_mean_sparsity_prop0.4', b.epoch_count) AS msp4,
	hps3.get_channel(a.config_id, 'train_stochastic30_mean_sparsity_prop', b.epoch_count) AS msp5,
	hps3.get_channel(a.config_id, 'train_stochastic30_mean_unit_sparsity_meta_prop', b.epoch_count) AS musmp,
	hps3.get_channel(a.config_id, 'train_stochastic30_mean_unit_sparsity_meta_prop2', b.epoch_count) AS musmp2,
...
FROM 	hps3.config_mlp_sgd AS a, (	
	...
	) AS b, hps3.dataset AS p, stochastic.layer_stochastic3 AS v, stochastic.layer_stochasticsoftmax AS n
WHERE  a.config_id = b.config_id AND b.rank = 1 AND (a.task_id = 45) AND a.dataset_id = p.dataset_id 
