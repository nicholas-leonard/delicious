SELECT 	a.config_id, a.dataset_id, a.description, b.epoch_count AS epoch, hps3.get_end(a.config_id) AS eend, (a.end_time IS NOT NULL) AS done,
	n.w_lr_scale, v.hidden_activation, v.W_lr_scale, v.max_col_norm, v.dim, v.hidden_dim, v.stoch_grad_coeff, v.mean_loss_coeff, v.sparsity_target, v.sparsity_cost_coeff, 
	--v.weight_decay_coeff, v.max_col_norm, 
	...
	hps3.get_channel(a.config_id, 'train_stochastic20_mean_sparsity_prop0.2', b.epoch_count) AS msp2,
	hps3.get_channel(a.config_id, 'train_stochastic20_mean_sparsity_prop0.3', b.epoch_count) AS msp3,
	hps3.get_channel(a.config_id, 'train_stochastic20_mean_sparsity_prop0.4', b.epoch_count) AS msp4,
	hps3.get_channel(a.config_id, 'train_stochastic20_mean_sparsity_prop', b.epoch_count) AS msp5,
...
FROM 	hps3.config_mlp_sgd AS a, (	
	...
	) AS b, hps3.dataset AS p, stochastic.layer_stochastic2 AS v, stochastic.layer_stochasticsoftmax AS n
WHERE  a.config_id = b.config_id AND b.rank = 1 AND (a.task_id = 39 or task_id = 40 or a.task_id = 43) AND a.dataset_id = p.dataset_id 
	AND a.layer_array[1] = v.layer_id AND a.layer_array[2] = n.layer_id --AND task_id = 43
